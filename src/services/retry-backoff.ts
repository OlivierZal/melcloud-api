 ...
 * The jitter is sampled uniformly in [delay * (1 - ratio), delay * (1 + ratio)],
 * clamped to maxDelayMs. Using Math.random here is acceptable: retry timing
 * isn't security-sensitive, it's just desynchronization.
 */
const computeDelay = (
  attempt: number,
