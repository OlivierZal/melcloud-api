...
import { classicAtaDevice } from '../classic-fixtures.ts'
...
describe('device model', () => {
  it('creates a device with correct properties', () => {
    const device = new ClassicDevice(classicAtaDevice())
  ...
  it('handles null floor and area ids', () => {
    const device = new ClassicDevice(
      classicAtaDevice({ AreaID: null, FloorID: null }),
    )
